...
// ============================================================
// Extracted outside HomeContent to prevent remounting on every keystroke.
// This fixes the mobile keyboard dismissing issue - defining components
// inside render functions creates new component identities each render.
interface LockedOverlayProps {
    isRequestMode: boolean;
    setIsRequestMode: (value: boolean) => void;
    authError: string;
    setAuthError: (value: string) => void;
    unlockForm: { email: string; code: string };
    setUnlockForm: (value: { email: string; code: string }) => void;
